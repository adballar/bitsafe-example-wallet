...
public class SendDialog extends javax.swing.JDialog {
    ...
    private final LinkedList<SendRecipientPanel> recipientsList;
    ...
    private void initComponents() {
        ...
        recipientsPanel = new javax.swing.JPanel();
        ...
        addRecipientButton.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        recipientsPanel.setLayout(new javax.swing.BoxLayout(recipientsPanel, javax.swing.BoxLayout.PAGE_AXIS));
        jScrollPane.setViewportView(recipientsPanel);
    ...
    public final void addRecipient() {
        SendRecipientPanel r = new SendRecipientPanel();
        recipientsPanel.add(r);
        recipientsPanel.revalidate();
        revalidate();
        recipientsList.add(r);
    }

    public SendRecipient[] getSendRecipients() {
        SendRecipient[] r = new SendRecipient[recipientsList.size()];
        Iterator<SendRecipientPanel> iterator = recipientsList.iterator();
        int index = 0;
        while (iterator.hasNext()) {
            r[index++] = iterator.next().getSendRecipient();
        }
        return r;
    }
    ...
    private javax.swing.JPanel recipientsPanel;
